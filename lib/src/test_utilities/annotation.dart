...
class Annotation implements Comparable<Annotation> {
  ...
  Annotation(this.message, this.type, this.lineNumber,
      {required this.column, required this.length});
  ...
  int compareTo(Annotation other) {
    if (lineNumber != other.lineNumber) {
      return lineNumber != null ? lineNumber! - other.lineNumber! : -1;
    } else if (column != other.column) {
      return column != null ? column! - other.column! : -1;
    }
    return message?.compareTo(other.message ?? '') ?? -1;
  }
