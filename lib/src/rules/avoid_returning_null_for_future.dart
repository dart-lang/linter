...
Future being used to represent a potential value, or error, that will be
available at some time in the future it's almost always wrong to return null for
Future. Most of the time the developer simply forgot to put an async keyword on
the function.
