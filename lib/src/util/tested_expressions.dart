...
class TestedExpressions {
  ...
  LinkedHashSet<ContradictoryComparisons> evaluateInvariant() {
    ...
    final binaryExpression = testingExpression is BinaryExpression
        ...
        : null;
    final facts = binaryExpression != null
